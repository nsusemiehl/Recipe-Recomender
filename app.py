...
class Algorithm():
    ...
    def check_final(self,recipes_prop, user_cals, user_carbs, user_pro,\
                user_sod, cal_wgt, carbs_wgt, pro_wgt, sod_wgt,time_constraint, thousands ):
...
def ingredient_input():
    if request.method == 'POST':
        ...
        # cal_input = str(request.form['cal_input'])
        # print("calorie input: ", cal_input)
        ...
        # AG.check_final(AG.recipes_prop_f(ingredient_list,thousands), user_cals, user_carbs, user_pro,\
        #     user_sod, cal_wgt, carbs_wgt, pro_wgt, sod_wgt,time_constraint, recipe_list, thousands) #what is purpose of this function?
        ...
        #############REDOING
        AG = Algorithm()
        recipes_prop = AG.recipes_prop_f(html_ingredients_list=ingredient_list, thousands=thousands, n=n)
        # test_df = recipes_prop[["recipe_name","ingredients","p"]]
        df_to_show = AG.check_final(recipes_prop, user_cals, user_carbs, user_pro,\
            user_sod, calw, carbw, prow, sodw,time_constraint, thousands)
        
        recipe_names = str(list(df_to_show['recipe_name']))
